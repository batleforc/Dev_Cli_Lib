...
// kopium command: kopium -f libs/crd/src/schemas/devworkspaces.yaml -A --derive Default -b
...
#[derive(
    CustomResource, Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema,
)]
#[kube(
...
#[kube(namespaced)]
#[kube(status = "DevWorkspaceStatus")]
#[kube(derive = "Default")]
pub struct DevWorkspaceSpec {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub contributions: Option<Vec<DevWorkspaceContributions>>,
    #[serde(
        default,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub template: Option<DevWorkspaceTemplate>,
}

#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub commands: Option<Vec<DevWorkspaceContributionsCommands>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub components: Option<Vec<DevWorkspaceContributionsComponents>>,
    ...
    #[builder(default, setter(strip_option))]
    pub import_reference_type: Option<DevWorkspaceContributionsImportReferenceType>,
    /// Reference to a Kubernetes CRD of type DevWorkspaceTemplate
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub kubernetes: Option<DevWorkspaceContributionsKubernetes>,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsCommands {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub apply: Option<DevWorkspaceContributionsCommandsApply>,
    /// Map of implementation-dependant free-form YAML attributes.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub attributes: Option<BTreeMap<String, serde_json::Value>>,
    ...
    #[builder(default, setter(strip_option))]
    pub command_type: Option<DevWorkspaceContributionsCommandsCommandType>,
    /// Composite command that allows executing several sub-commands either sequentially or concurrently
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub composite: Option<DevWorkspaceContributionsCommandsComposite>,
    /// CLI Command executed in an existing component container
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub exec: Option<DevWorkspaceContributionsCommandsExec>,
...
///  When no `apply` command exist for a given component, it is assumed the component will be applied at devworkspace start by default, unless `deployByDefault` for that component is set to false.
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsCommandsApply {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub group: Option<DevWorkspaceContributionsCommandsApplyGroup>,
...
/// Defines the group this command is part of
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsCommandsApplyGroup {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub kind: Option<DevWorkspaceContributionsCommandsApplyGroupKind>,
}

/// Defines the group this command is part of
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsCommandsApplyGroupKind {
    #[serde(rename = "build")]
    Build,
    #[serde(rename = "run")]
    Run,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsCommandsCommandType {
    Exec,
    Apply,
    Composite,
}
...
/// Composite command that allows executing several sub-commands either sequentially or concurrently
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsCommandsComposite {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub group: Option<DevWorkspaceContributionsCommandsCompositeGroup>,
    /// Optional label that provides a label for this command to be used in Editor UI menus for example
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub label: Option<String>,
...
/// Defines the group this command is part of
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsCommandsCompositeGroup {
    /// Identifies the default command for a given group kind
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "isDefault")]
    #[builder(default, setter(strip_option))]
    pub is_default: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub kind: Option<DevWorkspaceContributionsCommandsCompositeGroupKind>,
}

/// Defines the group this command is part of
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsCommandsCompositeGroupKind {
    #[serde(rename = "build")]
    Build,
    #[serde(rename = "run")]
    Run,
...
/// CLI Command executed in an existing component container
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsCommandsExec {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub env: Option<Vec<DevWorkspaceContributionsCommandsExecEnv>>,
    /// Defines the group this command is part of
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub group: Option<DevWorkspaceContributionsCommandsExecGroup>,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsCommandsExecEnv {
    pub name: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
...
/// Defines the group this command is part of
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsCommandsExecGroup {
    /// Identifies the default command for a given group kind
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "isDefault")]
    #[builder(default, setter(strip_option))]
    pub is_default: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub kind: Option<DevWorkspaceContributionsCommandsExecGroupKind>,
}

/// Defines the group this command is part of
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsCommandsExecGroupKind {
    #[serde(rename = "build")]
    Build,
    #[serde(rename = "run")]
    Run,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponents {
    /// Map of implementation-dependant free-form YAML attributes.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub attributes: Option<BTreeMap<String, serde_json::Value>>,
    ...
    #[builder(default, setter(strip_option))]
    pub component_type: Option<DevWorkspaceContributionsComponentsComponentType>,
    /// Allows adding and configuring devworkspace-related containers
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub container: Option<DevWorkspaceContributionsComponentsContainer>,
    /// Allows specifying the definition of an image for outer loop builds
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub image: Option<DevWorkspaceContributionsComponentsImage>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub kubernetes: Option<DevWorkspaceContributionsComponentsKubernetes>,
    /// Mandatory name that allows referencing the component from other elements (such as commands) or from an external devfile that may reference this component through a parent or a plugin.
    pub name: String,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub openshift: Option<DevWorkspaceContributionsComponentsOpenshift>,
    /// Allows specifying the definition of a volume shared by several other components
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub volume: Option<DevWorkspaceContributionsComponentsVolume>,
}

#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsComponentType {
    Container,
    Kubernetes,
    Openshift,
    Volume,
...
/// Allows adding and configuring devworkspace-related containers
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsContainer {
    /// Annotations that should be added to specific resources for this container
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub annotation: Option<DevWorkspaceContributionsComponentsContainerAnnotation>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub endpoints: Option<Vec<DevWorkspaceContributionsComponentsContainerEndpoints>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub env: Option<Vec<DevWorkspaceContributionsComponentsContainerEnv>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub volume_mounts: Option<Vec<DevWorkspaceContributionsComponentsContainerVolumeMounts>>,
}

/// Annotations that should be added to specific resources for this container
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsContainerAnnotation {
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsContainerEndpoints {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub exposure: Option<DevWorkspaceContributionsComponentsContainerEndpointsExposure>,
    pub name: String,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub protocol: Option<DevWorkspaceContributionsComponentsContainerEndpointsProtocol>,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsContainerEndpointsExposure {
    #[serde(rename = "public")]
    Public,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsContainerEndpointsProtocol {
    #[serde(rename = "http")]
    Http,
    #[serde(rename = "https")]
    Https,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsContainerEnv {
    pub name: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub value: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsContainerVolumeMounts {
...
/// Allows specifying the definition of an image for outer loop builds
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsImage {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub dockerfile: Option<DevWorkspaceContributionsComponentsImageDockerfile>,
    ...
    #[builder(default, setter(strip_option))]
    pub image_type: Option<DevWorkspaceContributionsComponentsImageImageType>,
}

/// Allows specifying dockerfile type build
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsImageDockerfile {
    ...
    #[builder(default, setter(strip_option))]
    pub devfile_registry: Option<DevWorkspaceContributionsComponentsImageDockerfileDevfileRegistry>,
    /// Dockerfile's Git source
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub git: Option<DevWorkspaceContributionsComponentsImageDockerfileGit>,
    ...
    #[builder(default, setter(strip_option))]
    pub src_type: Option<DevWorkspaceContributionsComponentsImageDockerfileSrcType>,
...
/// Dockerfile's Devfile Registry source
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsImageDockerfileDevfileRegistry {
...
/// Dockerfile's Git source
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsImageDockerfileGit {
    ...
    #[builder(default, setter(strip_option))]
    pub checkout_from: Option<DevWorkspaceContributionsComponentsImageDockerfileGitCheckoutFrom>,
...
/// Defines from what the project should be checked out. Required if there are more than one remote configured
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsImageDockerfileGitCheckoutFrom {
...
/// Allows specifying dockerfile type build
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsImageDockerfileSrcType {
    Uri,
    DevfileRegistry,
    Git,
}
...
/// Allows specifying the definition of an image for outer loop builds
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsImageImageType {
    Dockerfile,
    AutoBuild,
}
...
/// Allows importing into the devworkspace the Kubernetes resources defined in a given manifest. For example this allows reusing the Kubernetes definitions used to deploy some runtime components in production.
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsKubernetes {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub endpoints: Option<Vec<DevWorkspaceContributionsComponentsKubernetesEndpoints>>,
    /// Inlined manifest
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub location_type: Option<DevWorkspaceContributionsComponentsKubernetesLocationType>,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsKubernetesEndpoints {
    /// Annotations to be added to Kubernetes Ingress or Openshift Route
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub annotation: Option<BTreeMap<String, String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub exposure: Option<DevWorkspaceContributionsComponentsKubernetesEndpointsExposure>,
    pub name: String,
    /// Path of the endpoint URL
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub protocol: Option<DevWorkspaceContributionsComponentsKubernetesEndpointsProtocol>,
    /// Describes whether the endpoint should be secured and protected by some authentication process. This requires a protocol of `https` or `wss`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub secure: Option<bool>,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsKubernetesEndpointsExposure {
    #[serde(rename = "public")]
    Public,
    #[serde(rename = "internal")]
    Internal,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsKubernetesEndpointsProtocol {
    #[serde(rename = "http")]
    Http,
    #[serde(rename = "https")]
    Https,
...
/// Allows importing into the devworkspace the Kubernetes resources defined in a given manifest. For example this allows reusing the Kubernetes definitions used to deploy some runtime components in production.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsKubernetesLocationType {
    Uri,
    Inlined,
}
...
/// Allows importing into the devworkspace the OpenShift resources defined in a given manifest. For example this allows reusing the OpenShift definitions used to deploy some runtime components in production.
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsOpenshift {
    /// Defines if the component should be deployed during startup.
    ///  Default value is `false`
    #[serde(
        default,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub endpoints: Option<Vec<DevWorkspaceContributionsComponentsOpenshiftEndpoints>>,
    /// Inlined manifest
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub inlined: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub location_type: Option<DevWorkspaceContributionsComponentsOpenshiftLocationType>,
    /// Location in a file fetched from a uri.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub uri: Option<String>,
...
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsOpenshiftEndpoints {
    /// Annotations to be added to Kubernetes Ingress or Openshift Route
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub annotation: Option<BTreeMap<String, String>>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub exposure: Option<DevWorkspaceContributionsComponentsOpenshiftEndpointsExposure>,
    pub name: String,
    /// Path of the endpoint URL
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub protocol: Option<DevWorkspaceContributionsComponentsOpenshiftEndpointsProtocol>,
    /// Describes whether the endpoint should be secured and protected by some authentication process. This requires a protocol of `https` or `wss`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub secure: Option<bool>,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsOpenshiftEndpointsExposure {
    #[serde(rename = "public")]
    Public,
    #[serde(rename = "internal")]
    Internal,
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsOpenshiftEndpointsProtocol {
    #[serde(rename = "http")]
    Http,
    #[serde(rename = "https")]
    Https,
...
/// Allows importing into the devworkspace the OpenShift resources defined in a given manifest. For example this allows reusing the OpenShift definitions used to deploy some runtime components in production.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsComponentsOpenshiftLocationType {
    Uri,
    Inlined,
}
...
/// Allows specifying the definition of a volume shared by several other components
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsComponentsVolume {
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum DevWorkspaceContributionsImportReferenceType {
    Uri,
    Id,
    Kubernetes,
}
...
/// Reference to a Kubernetes CRD of type DevWorkspaceTemplate
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceContributionsKubernetes {
    pub name: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
...
/// Structure of the devworkspace. This is also the specification of a devworkspace template.
#[derive(Serialize, Deserialize, Clone, Debug, TypedBuilder, Default, JsonSchema)]
pub struct DevWorkspaceTemplate {
    /// Map of implementation-dependant free-form YAML attributes.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub attributes: Option<BTreeMap<String, serde_json::Value>>,
...
pub struct DevWorkspaceTemplateComponentsPluginComponentsContainer {
    ...
    #[builder(default, setter(strip_option))]
    pub volume_mounts:
        Option<Vec<DevWorkspaceTemplateComponentsPluginComponentsContainerVolumeMounts>>,
}
...
pub struct DevWorkspaceTemplateComponentsPluginComponentsImageDockerfile {
    ...
    pub devfile_registry:
        Option<DevWorkspaceTemplateComponentsPluginComponentsImageDockerfileDevfileRegistry>,
    /// Dockerfile's Git source
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
...
pub struct DevWorkspaceTemplateComponentsPluginComponentsImageDockerfileGit {
    ...
    #[builder(default, setter(strip_option))]
    pub checkout_from:
        Option<DevWorkspaceTemplateComponentsPluginComponentsImageDockerfileGitCheckoutFrom>,
    /// Location of the Dockerfile in the Git repository when using git as Dockerfile src. Defaults to Dockerfile.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DevWorkspaceTemplateParentComponentsImageDockerfile {
    ...
    #[builder(default, setter(strip_option))]
    pub devfile_registry:
        Option<DevWorkspaceTemplateParentComponentsImageDockerfileDevfileRegistry>,
    /// Dockerfile's Git source
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
...
pub struct DevWorkspaceTemplateParentComponentsPlugin {
    ...
    pub import_reference_type:
        Option<DevWorkspaceTemplateParentComponentsPluginImportReferenceType>,
    /// Reference to a Kubernetes CRD of type DevWorkspaceTemplate
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
...
pub struct DevWorkspaceTemplateParentComponentsPluginComponentsContainer {
    ...
    #[builder(default, setter(strip_option))]
    pub endpoints:
        Option<Vec<DevWorkspaceTemplateParentComponentsPluginComponentsContainerEndpoints>>,
    /// Environment variables used in this container.
    ///  The following variables are reserved and cannot be overridden via env:
    ///   - `$PROJECTS_ROOT`
    ///   - `$PROJECT_SOURCE`
    ...
    #[builder(default, setter(strip_option))]
    pub volume_mounts:
        Option<Vec<DevWorkspaceTemplateParentComponentsPluginComponentsContainerVolumeMounts>>,
}
...
pub struct DevWorkspaceTemplateParentComponentsPluginComponentsContainerEndpoints {
    ...
    #[builder(default, setter(strip_option))]
    pub exposure:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsContainerEndpointsExposure>,
    pub name: String,
    /// Path of the endpoint URL
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub protocol:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsContainerEndpointsProtocol>,
    /// Describes whether the endpoint should be secured and protected by some authentication process. This requires a protocol of `https` or `wss`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub secure: Option<bool>,
...
pub struct DevWorkspaceTemplateParentComponentsPluginComponentsImageDockerfile {
    ...
    #[builder(default, setter(strip_option))]
    pub devfile_registry:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsImageDockerfileDevfileRegistry>,
    /// Dockerfile's Git source
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub src_type:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsImageDockerfileSrcType>,
    /// URI Reference of a Dockerfile. It can be a full URL or a relative URI from the current devfile as the base URI.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub uri: Option<String>,
...
pub struct DevWorkspaceTemplateParentComponentsPluginComponentsImageDockerfileGit {
    ...
    #[builder(default, setter(strip_option))]
    pub checkout_from:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsImageDockerfileGitCheckoutFrom>,
    /// Location of the Dockerfile in the Git repository when using git as Dockerfile src. Defaults to Dockerfile.
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct DevWorkspaceTemplateParentComponentsPluginComponentsKubernetes {
    ...
    #[builder(default, setter(strip_option))]
    pub endpoints:
        Option<Vec<DevWorkspaceTemplateParentComponentsPluginComponentsKubernetesEndpoints>>,
    /// Inlined manifest
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub inlined: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub location_type:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsKubernetesLocationType>,
    /// Location in a file fetched from a uri.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub uri: Option<String>,
...
pub struct DevWorkspaceTemplateParentComponentsPluginComponentsKubernetesEndpoints {
    ...
    #[builder(default, setter(strip_option))]
    pub exposure:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsKubernetesEndpointsExposure>,
    pub name: String,
    /// Path of the endpoint URL
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub protocol:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsKubernetesEndpointsProtocol>,
    /// Describes whether the endpoint should be secured and protected by some authentication process. This requires a protocol of `https` or `wss`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub secure: Option<bool>,
...
pub struct DevWorkspaceTemplateParentComponentsPluginComponentsOpenshift {
    ...
    #[builder(default, setter(strip_option))]
    pub endpoints:
        Option<Vec<DevWorkspaceTemplateParentComponentsPluginComponentsOpenshiftEndpoints>>,
    /// Inlined manifest
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub inlined: Option<String>,
    ...
    #[builder(default, setter(strip_option))]
    pub location_type:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsOpenshiftLocationType>,
    /// Location in a file fetched from a uri.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub uri: Option<String>,
...
pub struct DevWorkspaceTemplateParentComponentsPluginComponentsOpenshiftEndpoints {
    ...
    #[builder(default, setter(strip_option))]
    pub exposure:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsOpenshiftEndpointsExposure>,
    pub name: String,
    /// Path of the endpoint URL
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    ...
    #[builder(default, setter(strip_option))]
    pub protocol:
        Option<DevWorkspaceTemplateParentComponentsPluginComponentsOpenshiftEndpointsProtocol>,
    /// Describes whether the endpoint should be secured and protected by some authentication process. This requires a protocol of `https` or `wss`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[builder(default, setter(strip_option))]
    pub secure: Option<bool>,
...
pub struct DevWorkspaceStatus {
    ...
    #[serde(rename = "devworkspaceId")]
    pub devworkspace_id: String,
    /// Main URL for this DevWorkspace
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "mainUrl")]
    #[builder(default, setter(strip_option))]
